...
import (
	...
	"github.com/redhat-appstudio/helmet/example/helmet-ex/integrations"
...
func main() {
	...
	appIntegrations = framework.WithGitHubURLProvider(appIntegrations, integrations.CustomURLProvider{})
